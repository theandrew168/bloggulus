...
// as the key.
func SetContextAccount(r *http.Request, account webquery.Account) *http.Request {
...
func GetContextAccount(r *http.Request) (webquery.Account, bool) {
	account, ok := r.Context().Value(contextKeyAccount).(webquery.Account)
	return account, ok
}
